...
#---
defmodule BookSearchWeb.CoreComponents do
  @moduledoc """
  ...
  def translate_error({msg, opts}) do
    ...
    if count = opts[:count] do
      Gettext.dngettext(BookSearchWeb.Gettext, "errors", msg, msg, count, opts)
    else
      Gettext.dgettext(BookSearchWeb.Gettext, "errors", msg, opts)
    end
  end
