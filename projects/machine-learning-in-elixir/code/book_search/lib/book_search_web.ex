...
defmodule BookSearchWeb do
  ...
  def controller do
    quote do
      use Phoenix.Controller,
        formats: [:html, :json],
        layouts: [html: BookSearchWeb.Layouts]
  ...
  def live_view do
    quote do
      use Phoenix.LiveView,
        layout: {BookSearchWeb.Layouts, :app}
  ...
  defp html_helpers do
    quote do
      ...
      import BookSearchWeb.CoreComponents
      import BookSearchWeb.Gettext
  ...
  def verified_routes do
    quote do
      use Phoenix.VerifiedRoutes,
        ...
        router: BookSearchWeb.Router,
        statics: BookSearchWeb.static_paths()
    end
  end
